...
export const languageKorean = {
  ...
  lazyLoad: {
    loading: "불러오는 중…",
    failedTitle: "불러오지 못했습니다",
    failedHint: "비어 있는 것이 아니라, 읽지 못한 것입니다. 여기 보이는 내용은 불완전할 수 있습니다.",
    retry: "다시 시도",
    characterFailed: "캐릭터를 열지 못했습니다",
    chatFailed: "채팅을 열지 못했습니다",
    personasFailed: "이 캐릭터의 페르소나를 불러오지 못했습니다",
    olderMessagesFailed: "이전 메시지를 불러오지 못했습니다",
    newestMessagesFailed: "최신 메시지로 돌아가지 못했습니다",
  },
