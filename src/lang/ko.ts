...
export const languageKorean = {
  ...
  modelPresetPageFoldEnable: "PageFold 최적화 사용",
  modelPresetPageFoldEnableHelp: "이 프리셋의 메인·보조·기타 보조 요청 프롬프트를 PDF로 패키징합니다.",
  modelPresetPageFoldTarget: "프리셋 라우트: ",
  modelPresetPageFoldUnsupported: "이 프로필은 호환되지 않습니다. 현재 Google AI Studio, Vertex Gemini Native, OpenRouter, LLM Gateway 프리셋을 지원합니다.",
  modelPresetPageFoldWarning: "PageFold는 이 프리셋의 모델·엔드포인트·인증 정보를 그대로 사용합니다. 전역 PageFold 설정은 패키징·폰트·통계만 제어합니다. 활성화 중에는 스트리밍, 도구, 이미지와 제공자 네이티브 컨텍스트 캐싱을 사용하지 않습니다.",
  modelPresetPageFoldSettings: "PageFold 패키징 설정 열기",
  ...
  pluginUpdateFailedAt: "플러그인 업데이트 실패: {}",
  pluginUpdateStageDownload: "업데이트를 내려받지 못했습니다.",
  pluginUpdateStageParse: "내려받은 플러그인을 읽지 못했습니다.",
  pluginUpdateStagePolicy: "플러그인 보안 정책에 의해 차단되었습니다.",
  pluginUpdateStageSave: "업데이트를 저장하지 못했습니다.",
  pluginUpdateStageVerify: "설치 후 업데이트를 검증하지 못했습니다.",
  pluginUpdateSourceMoved: "이 플러그인의 업데이트 주소가 {}(으)로 변경되었습니다.",
  ...
  risuBardWikiRebootDescription: "첫 AI 응답부터 현재까지 BardWiki를 새로 만듭니다.",
  ...
  risuBardWikiRebootWarning: "현재 대화의 첫 AI 응답부터 BardWiki를 새로 생성합니다. 완성되기 전까지 새 응답을 생성할 수 없으며, 기존 위키는 마지막 교체 전까지 유지됩니다. 계속할까요?",
