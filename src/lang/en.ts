...
export const languageEnglish = {
    ...
    settingsWorkspace: {
        ...
        personaManager: {
            eyebrow: "Active writing identity",
    ...
    risuBardWikiPrompt: {
        ...
        description: "Manage prompt blocks used only for BardWiki event analysis and canonical writing. Core contracts and runtime injection anchors are read-only.",
        audience: "Audience",
