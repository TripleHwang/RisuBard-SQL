...
export const languageEnglish = {
    ...
    systemUpdateTab: "Updates",
    systemUpdateDesc: "Check for a compatible RisuVault patch and apply it from inside the app.",
    systemUpdateChannel: "Update channel",
    systemUpdateTrust: "Only packages built for this RisuVault repository and deployment type are offered. HaejeokRisuAI packages are never installed directly.",
    systemUpdateCheck: "Check now",
    systemUpdateChecking: "Checking...",
    systemUpdateCheckFailed: "Could not check for updates. Check the network connection and try again.",
    systemUpdateCurrent: "Current version",
    systemUpdateLatest: "Latest version",
    systemUpdateAvailable: "RisuVault {{version}} is available.",
    systemUpdateUpToDate: "You are using the latest compatible version.",
    close: "Close",
    ...
    modelPresetPageFoldSection: "PageFold",
    modelPresetPageFoldEnable: "Use PageFold optimization",
    modelPresetPageFoldEnableHelp: "Package this preset's prompt as a PDF for main, sub and auxiliary requests.",
    modelPresetPageFoldTarget: "Preset route: ",
    modelPresetPageFoldUnsupported: "This profile is not compatible. PageFold currently supports Google AI Studio, Vertex Gemini Native, OpenRouter and LLM Gateway presets.",
    modelPresetPageFoldWarning: "PageFold uses this preset's model, endpoint and credential. Global PageFold settings only control packaging, fonts and statistics. Streaming, tools, images and provider-native context caching are not used while PageFold is enabled.",
    modelPresetPageFoldSettings: "Open PageFold packaging settings",
    ...
    inlayPermissionConsent: "Plugin {} is requesting permission to read inlay images. Do you want to allow this?",
    localToggles: "Store sidebar toggles for this chat",
    localToggleReset: "Remove this chat override and use the global value",
    ...
    risuBardWikiRebootDescription: "Rebuild BardWiki from the first AI response through the present.",
    ...
    risuBardWikiRebootWarning: "BardWiki will be rebuilt from this conversation's first AI response. New responses are unavailable until it finishes, and the existing wiki remains in place until the final replacement. Continue?",
