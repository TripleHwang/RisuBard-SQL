...
describe('memory save slot client', () => {
    ...
    test.each([false, true])('saves story state without prompt preferences with overwrite=%s', async (overwrite) => {
        ...
        for (const key of ['bindedBotPreset', 'usePromptPresetParams', 'useModelPreset', 'modelBinding', 'useLocallySetGlobalVariables', 'savedToggleValues']) {
    ...
    test('lists strict summaries and decodes a prepared chat load', async () => {
        ...
        const loaded = await prepareMemorySaveLoad({
            ...
            currentChat: {
                ...
                useModelPreset: true,
                modelBinding: { main: 'current-main', sub: '', separateAux: false, aux: {} },
                useLocallySetGlobalVariables: true,
        ...
        expect(loaded).toMatchObject({
            ...
            chat: {
                ...
                useModelPreset: true,
                modelBinding: { main: 'current-main' },
                useLocallySetGlobalVariables: true,
                GLGlobalVariables: { toggle_language: 'ko' },
            },
        })
    ...
    test.each([
        { name: 'pinned', current: {
            ...
            useModelPreset: true,
            modelBinding: { main: 'new-main', sub: '', separateAux: false, aux: {} },
            useLocallySetGlobalVariables: true,
        ...
        const savedChat: Chat = {
            ...
            modelBinding: { main: 'old-main', sub: '', separateAux: false, aux: {} },
            useLocallySetGlobalVariables: true,
