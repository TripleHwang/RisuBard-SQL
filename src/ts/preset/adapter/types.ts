...
export interface AdapterChatOptions {
    ...
    /** Used by structured internal calls that need a short deterministic answer. */
    reasoningEffort?: 'minimal'
    /** Provider-neutral JSON Schema requested by the caller for this response.
     *  Adapters translate it to their supported wire dialect and keep it
     *  authoritative over profile customBody output-format fields. */
